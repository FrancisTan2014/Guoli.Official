$.fn.THBanner = function (arg) {
    ...
    var itemLen = $(this).find(".banner-item").length;
    var opt = {}
    opt.timer = 8000;
    opt.index = 0;
    opt = $.extend(opt, arg);
    ...
    if (itemLen > 1) {
        var bannerTool = $(this).find(".banner-tool");
